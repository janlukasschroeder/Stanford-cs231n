...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W3'] = weight_scale * np.random.randn(num_filters * H * W / 4, num_classes)
    ...
    print 'Initialisation of class ThreeLayerConvNet successful'
  ...
  def loss(self, X, y=None):
    ...
    #out2, cache2 = conv_forward_strides(out1, W2, b2, conv_param)
    ...
    data_loss, da4 = softmax_loss(scores, y)
    ...
    da3, dW3, db3 = affine_backward(da4, cache4)
    da2 = relu_backward(da3, cache3)
    da2, dW2, db2 = affine_backward(da2, cache2)
    #da1, dW2, db2 = conv_backward_strides(da2 ,cache2)
